...
import it.polito.wa2.g17.turnstileservice.dtos.TurnstileJwtDTO
import it.polito.wa2.g17.turnstileservice.dtos.UserJwtDTO
import it.polito.wa2.g17.turnstileservice.exceptions.InvalidJwtException
...
class JwtUtils : InitializingBean {
    ...
    fun getDetailsJwtTurnstile(authToken: String) : TurnstileJwtDTO {
        ...
        try{
            ...
            zone = validatedJwt.body["zone"].toString()
        }
        catch (e: Exception){
            throw InvalidJwtException()
        }

        return TurnstileJwtDTO(id, zone)
    }
