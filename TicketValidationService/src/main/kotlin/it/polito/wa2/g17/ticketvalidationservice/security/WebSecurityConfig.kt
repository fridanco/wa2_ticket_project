    ...
    override fun configure(http: HttpSecurity?) {
        http?.let {
            ...
            it.authorizeRequests()
                .antMatchers("/ticket/validation/embedded/**").hasAuthority("ROLE_EMBEDDED")
                .antMatchers("/ticket/validation/user/**").hasAuthority("ROLE_CUSTOMER")
                .antMatchers("/ticket/validation/admin/**").hasAuthority("ROLE_ADMIN").and()
