package it.polito.wa2.g17.paymentservice.security
    ...
    override fun configure(http: HttpSecurity?) {
        http?.let {
            ...
            it.authorizeRequests()
                .antMatchers("/payment/user/**").hasAuthority("ROLE_CUSTOMER")
                .antMatchers("/payment/admin/**").hasAuthority("ROLE_ADMIN").and()
